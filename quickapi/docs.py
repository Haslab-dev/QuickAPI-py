"""
QuickAPI OpenAPI Documentation Generator

Generates OpenAPI/Swagger specifications for QuickAPI applications.
"""
...
class OpenAPIGenerator:
    ...
    def __init__(self, app):
        ...
        Args:
            app: QuickAPI application instance
        """
        self.app = app
    ...
    def _generate_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": f"API generated by QuickAPI",
            "contact": {
                "name": "QuickAPI Team",
                "url": "https://github.com/quickapi/quickapi"
            },
            "license": {
                "name": "MIT",
...
<html>
<head>
    <title>QuickAPI - Swagger UI</title>
    <meta charset="utf-8" />
...
def generate_openapi_spec(app) -> Dict[str, Any]:
    """
    Generate OpenAPI specification for a QuickAPI app.
